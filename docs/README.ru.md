...
### 🌏 Локализация
Программа имеет локализованный интерфейс и расширенную поддержку распознавания речи.
...
<table style="border-spacing: 25px; text-align: center; width: 100%;">
  ...
  <tr>
    ...
    <td valign="top" width="33%">
      <b>📋 Лог событий</b><br>
      <img src="resource/image/screen-showlog.png" width="780px"><br>
  ...
  <tr>
    <td valign="top" width="33%">
      ...
      <img src="resource/image/screen-ingegration.png" width="780px"><br>
    ...
    <td valign="top" width="33%" colspan="2">
      ...
      <img src="resource/image/screen-import-export.png" width="1000px"><br>
...
2.  **Запустите ассистента:** Нажмите 2 раза ЛКМ по `Uvoxus.exe`.
3.  **Откройте настройки:** Перейдите во вкладку **«Настройки»**.
4.  **Выберите микрофон и чувствительность:** В разделе «Аудио и Чувствительность» найдите пункт **«Активный микрофон»** и выберите ваше основное устройство. **Это самый важный шаг!** Также настройте чувствительность под себя.
5.  **Задайте имя:** В настройках на главной странице найдите поле ввода имени и впишите одно или несколько имён для активации (например, `Джарвис`, `Ассистент`).
6.  **Сохраните изменения.**
7.  **Проверка:** Вернитесь на вкладку **«Главная»** и произнесите имя ассистента. Статус должен измениться на **«СЛУШАЮ…»**, а анимированный индикатор начнёт реагировать на ваш голос.
